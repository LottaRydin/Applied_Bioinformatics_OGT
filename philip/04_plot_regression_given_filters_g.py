...
def regression_filter_plot(type_T, min_read, min_samp, diff_from_max, xy_transform = False):
...
regression_filter_plot("opt", 5, 5, 5, xy_transform=False) #opt
regression_filter_plot("min", 5, 5, 5) #min
regression_filter_plot("max", 5, 5, 5) #max
