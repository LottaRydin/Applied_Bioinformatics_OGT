...
def leave_1_out(df, min_read, min_samp, ratio, min_z, max_z, min_val, xy_transform = False):
...
leave_1_out(df, p_min_read, p_min_samp, p_ratio, p_z_min, p_z_max, min_val, xy_transform=True) #opt
leave_1_out(df, p_min_read, p_min_samp, p_ratio, p_z_max, p_z_max, 0, xy_transform=True) #opt