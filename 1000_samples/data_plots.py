...
tempura_df = pd.read_csv("matched_temp_multi_v2.tsv", sep='\t')
...
#DATA FILTERING for abundance, min nr of samples per OTU
#Filter for number of samples per OTU
#appended_df = df.drop(df[df.abundance < 4].index) #drop sample with less that 4 reads
#filter 
