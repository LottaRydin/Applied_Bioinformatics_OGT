...
def regression_filter_plot(df, min_read, min_samp, ratio, min_z, max_z, xy_transform = False):
...
regression_filter_plot(df, p_min_read, p_min_samp, p_ratio, p_z_min, p_z_max, xy_transform=False) #opt
regression_filter_plot(df, p_min_read, p_min_samp, p_ratio, p_z_min, p_z_max, xy_transform=True) #opt
