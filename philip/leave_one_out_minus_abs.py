...
def leave_1_out(df, type_T, min_read, min_samp, diff_from_max, max_z, xy_transform = False):
    ...
    plt.show()
leave_1_out(df, "opt", p_min_read, p_min_samp, p_diff_from_max, p_z_cutoff, xy_transform=True) #opt
leave_1_out(df, "max", p_min_read, p_min_samp, p_diff_from_max, p_z_cutoff, xy_transform=True) #max
leave_1_out(df, "min", p_min_read, p_min_samp, p_diff_from_max, p_z_cutoff, xy_transform=True) #min